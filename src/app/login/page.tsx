...
const Page = () => {
  return (
    <div className="w-full h-screen grid place-content-center">
      <div className="p-10 shadow-md shadow-[#d1d1d1] backdrop-blur-sm border border-[#efefef] rounded-xl md:w-[400px] bg-white">
        <p className="capitalize text-center">hi there,</p>
